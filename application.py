...
define("mysql_database", default = "cloudindex", help = "community database name")
define("mysql_user", default = "", help = "community database user")
define("mysql_password", default = "", help = "community database password")
...
if __name__ == "__main__":
    daemon.daemonize(stdin='/dev/null',stdout= 'output.log', stderr= 'error.log')
    main()
